...
if(!target)target='CNY';
function fmt(v){try{return new Intl.NumberFormat('zh-CN',{maximumSignificantDigits:3}).format(v);}catch(e){return String(Math.round(v*100)/100);}}
function loadRates(){
  try{
