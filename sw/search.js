(function(){
  ...
  function build(){
    ...
    overlay.setAttribute('aria-label','Tafuta Met Road');
    overlay.hidden = true;
    overlay.innerHTML =
      ...
      '<div class="msearch-card" role="document">'+
        '<div class="msearch-head">'+
          ...
          '<input type="text" class="msearch-input" id="msearchInput" placeholder="Tafuta miji, njia, nchi…" autocomplete="off" autocapitalize="off" spellcheck="false" aria-label="Search" aria-controls="msearchList" role="combobox" aria-expanded="true">'+
        ...
        '<div class="msearch-foot"><span><kbd>/</kbd> kutafuta &middot; <kbd>Esc</kbd> kufunga &middot; <kbd>&uarr;</kbd><kbd>&darr;</kbd> kusogeza &middot; <kbd>&crarr;</kbd> kufungua</span></div>'+
      '</div>';
  ...
  function render(query){
    ...
    if(!query.trim()){
      list.innerHTML = '<li class="msearch-hint-row" role="presentation">Anza kuandika jiji, njia au nchi…</li>';
      return;
    }
    if(!results.length){
