(function(){
  ...
  function build(){
    ...
    overlay.setAttribute('aria-label','Met Road में खोजें');
    overlay.hidden = true;
    overlay.innerHTML =
      ...
      '<div class="msearch-card" role="document">'+
        '<div class="msearch-head">'+
          ...
          '<input type="text" class="msearch-input" id="msearchInput" placeholder="शहर, लाइन, देश खोजें…" autocomplete="off" autocapitalize="off" spellcheck="false" aria-label="Search" aria-controls="msearchList" role="combobox" aria-expanded="true">'+
        ...
        '<div class="msearch-foot"><span><kbd>/</kbd> खोज &middot; <kbd>Esc</kbd> बंद &middot; <kbd>&uarr;</kbd><kbd>&darr;</kbd> नेविगेट &middot; <kbd>&crarr;</kbd> खोलें</span></div>'+
      '</div>';
  ...
  function render(query){
    ...
    if(!query.trim()){
      list.innerHTML = '<li class="msearch-hint-row" role="presentation">शहर, लाइन या देश टाइप करना शुरू करें…</li>';
      return;
    }
    if(!results.length){
